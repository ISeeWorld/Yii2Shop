    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <a data-rel="prettyphoto" href="<?php echo $product['cover'] ?>-coverbig">
                <img class="img-responsive" alt="" src="http://<?php echo $product['cover'] ?>-small"  />
                </a>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <?php foreach((array)json_decode($product['pics'], true) as $k=>$pic): ?>
                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="<?php echo $i-1 ?>" href="#slide<?php echo $i ?>">
                    <img width="67" alt="" src="http://<?php echo $pic ?>-small"/>
                </a>
            <?php $i++; ?>
            <?php endforeach; ?>
            ...
            <?php foreach($data['all'] as $pro): ?>
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                            <img alt="<?php echo $pro->title ?>" src="http://<?php echo $pro->cover ?>-covermiddle" data-echo="<?php echo $pro->cover ?>-middle" />
                        </div>
                        <div class="body">
                            <div class="title">
